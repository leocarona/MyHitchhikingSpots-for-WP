...
namespace MyHitchhikingSpots
{
    public partial class App : Application
    {
        ...
        {
            // === The bellow comments and ApplicationId and AuthenticationToken were copied from the sample available at http://bit.ly/1f6xmrR: ===
            ...
            Microsoft.Phone.Maps.MapsSettings.ApplicationContext.ApplicationId = Constants.WP8ApplicationId;
            Microsoft.Phone.Maps.MapsSettings.ApplicationContext.AuthenticationToken = Constants.WP8AuthenticationToken;

            //DBs
            ServiceContainer.Register<PrivateDB>();
            ServiceContainer.Register<LocationsDB>();

            //View Models
            ServiceContainer.Register<MapViewModel>();
            ServiceContainer.Register<LogViewModel>();
            ServiceContainer.Register<LocationViewModel>();

            //Services
            ServiceContainer.Register<MapService>();
            ServiceContainer.Register<ILocateService>(() => new LocateService());
        }
        ...
        private void RootFrame_NavigationFailed(object sender, NavigationFailedEventArgs e)
        {
            ...
            {
#if DEBUG
                Tool.WriteExceptionMessagesToOutputBox(e.Exception);
#endif
        ...
        private void Application_UnhandledException(object sender, ApplicationUnhandledExceptionEventArgs e)
        {
            ...
            {
#if DEBUG
                Tool.WriteExceptionMessagesToOutputBox(e.ExceptionObject);
#endif
